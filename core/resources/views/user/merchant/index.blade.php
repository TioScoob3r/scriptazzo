          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col text-center">
                ...
                <span class="text-xl text-dark mb-0">{{$currency->symbol}} {{number_format($received, 2, ',', '.')}}</span><br>
                <hr>
              </div>
            </div>
            <div class="row align-items-center">
              ...
              <div class="col-auto">
                <div class="my-4">
                  ...
                  <span class="surtitle ">{{$currency->symbol}} {{number_format($abadoned, 2, ',', '.')}}</span><br>
