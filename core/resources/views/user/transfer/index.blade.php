  ...
  <div class="content-wrapper">
    <div class="row align-items-center py-4">
      <div class="col-lg-6 col-7">
        <h6 class="h2 d-inline-block mb-0">{{$lang["transfer_transfer_money"]}} Entre Contas AzzoPay</h6>
      </div>
      <div class="col-lg-6 col-5 text-right">
        <a data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-sm btn-neutral"><i class="fad fa-plus"></i> Transferir agora</a> 
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
              ...
              <div class="modal-body">
                <form action="{{route('submit.transfer')}}" method="post" id="modal-details">
                  ...
                  <div class="form-group row">
                    <label class="col-form-label col-lg-12">Digite o número da conta AzzoPay</label>
                    <div class="col-lg-12">
                        <input type="account_id" name="account_id" class="form-control" placeholder="Número da Conta AzzoPay" required>
                  ...
                  <div class="form-group row">
                    <label class="col-form-label col-lg-12">Valor a ser enviado</label>
                    <div class="col-lg-12">
                      ...
                      <span class="form-text text-xs">O valor a ser enviado, não pode ser estornado ou reembolsado.</span>
                    </div>
                  </div>                   
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                          ...
                          <p>Empresa: {{$val->sender['business_name']}}</p>
                          <p>Nº Conta: {{$val->sender['account_id']}}</p>
                          ...
                          <p>{{$lang["transfer_sent"]}}: {{$currency->symbol.number_format($val->amount, 2, ',', '.')}}</p>
                            ...
                            @else
                            <p>Para a Empresa: {{$val->receiver['business_name']}}</p>
                          	<p>Nº Conta: {{$val->sender['account_id']}}</p>
                            @endif
                          @endif
          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col text-center">
                ...
                <span class="text-xl text-dark mb-0">{{$currency->symbol}} {{number_format($sent, 2, ',', '.')}}</span><br>
                <hr>
              </div>
            </div>
            <div class="row align-items-center">
              ...
              <div class="col-auto">
                <div class="my-4">
                  <span class="surtitle ">{{$currency->symbol}} {{number_format($pending, 2, ',', '.')}}</span><br>
                  <span class="surtitle ">{{$currency->symbol}} {{number_format($rebursed, 2, ',', '.')}}</span><br>
