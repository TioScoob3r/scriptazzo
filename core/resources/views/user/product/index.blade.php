          ...
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col text-center">
                ...
                <span class="text-xl text-dark mb-0">{{$currency->symbol}} {{number_format($received)}}.00</span><br>
                <hr>
              </div>
            </div>
            <div class="row align-items-center">
              ...
              <div class="col-auto">
                <div class="my-4">
                  <span class="surtitle ">{{$currency->symbol}} 00.00</span><br>
                  <span class="surtitle ">{{$currency->symbol}} {{number_format($total)}}.00</span>
                </div>
              </div>
            </div>
          </div>
