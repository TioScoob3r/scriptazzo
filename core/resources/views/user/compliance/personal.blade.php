                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" name="first_name" id="first_name" maxlength="80"  class="form-control" value="{{$user->first_name}}" disabled required>    
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" name="last_name" id="last_name" maxlength="80"  class="form-control" value="{{$user->last_name}}" disabled required>    
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" name="cpf" id="cpf" maxlength="14"  class="form-control" value="{{$user->document}}" disabled required>    
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" name="rg" id="rg" maxlength="40" class="form-control" value="{{$user->document}}" disabled required>    
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <!--input type="date" name="birthday" id="birthday" class="form-control" 
                                                                   value="{{ $compliance->birthday ? date('Y-m-d', strtotime($compliance->birthday)) : '' }}" required--->    
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <!-- Opções de nacionalidade com condição para selecionar o Brasil por padrão -->
                                                    @foreach($bcountry as $val)
                                                        <option value="{{ $val->id }}" 
                                                            @if($compliance->nationality == $val->id || (empty($compliance->nationality) && $val->id == 30)) 
                                                                selected 
                                                            @endif>
                                                            {{ $val->nicename }}
                                                        </option>
                                            ...
                                            <div class="row">
                                                <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" name="email" id="email" maxlength="80"  class="form-control" value="{{$user->email}}" disabled required>    
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            @foreach($bcountry as $val)
                                                                @if(!empty($val->iso3))
                                                                    <option value="{{ $val->phonecode }}" 
                                                                        @if($compliance->phone_country_code == $val->phonecode || (empty($compliance->phone_country_code) && $val->phonecode == 55)) 
                                                                            selected 
                                                                        @endif>
                                                                        {{ $val->iso3 }}
                                                                    </option>
                                            ...
                                            <div class="row">
                                                <div class="col col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <select class="form-control select" name="mobilephone_country_code" id="mobilephone_country_code" disabled required>
                                                            <option value="">{{ $lang["compliance_personal_select_mobilephone_country_code"] }}</option> 

                                                            @foreach($bcountry as $val)
                                                                @if(!empty($val->iso3))
                                                                    <option value="{{ $val->phonecode }}" 
                                                                        @if($compliance->mobilephone_country_code == $val->phonecode || (empty($compliance->mobilephone_country_code) && $val->phonecode == 55)) 
                                                                            selected 
                                                                        @endif>
                                                                        {{ $val->iso3 }}
                                                                    </option>
                                                ...
                                                <div class="col col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                                    <div class="form-group row">
                                                        <label class="col-form-label col-lg-12">{{$lang["compliance_personal_phone_ddd"]}}</label>
                                                        <div class="col-lg-12">
                                                            <input type="text" name="mobilephone_ddd" id="mobilephone_ddd" maxlength="2" class="form-control" value="{{ substr($user->phone, 0, 2) }}" disabled required oninput="this.value = this.value.slice(0, 2);">
                                                        </div>
                                                ...
                                                <div class="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" name="mobilephone" id="mobilephone" maxlength="11" class="form-control" value="{{ substr($user->phone, 2, 11) }}" disabled required oninput="this.value = this.value.slice(2, 11);">
                                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mt-20">
                                                <div class="col col-md-6 col-lg-6 col-xs-6 col-sm-6 text-left">
                                                    <a href="{{route('user.account-compliance')}}" class="btn btn-neutral btn-block">Voltar
                                                ...
                                                <div class="col col-md-6 col-lg-6 col-xs-6 col-sm-6 text-right">  
                                                    ...
                                                    <button type="button" class="btn btn-info btn-block" onclick="saveInfo();">Salvar e Enviar Documentos
