  ...
  <div class="content-wrapper">
    <div class="card">
        <div class="card-header header-elements-inline">
            <h3 class="mb-0 font-weight-bolder">{{$lang["report_orders_title"]}}</h3>
        </div>
        ...
        <div class="card-body">
            <form action="{{route('user.submit.reports.links')}}" method="post">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
                        <button type="submit" class="btn btn-neutral my-4" ><i class="fad fa-external-link"></i>{{$lang["report_orders_btn_search"]}}</button>
                    </div>
                </div>
            </form>
            ...
            <div class="table-responsive py-4">
                <table class="table table-flush" id="datatable-buttons">
                    <thead>
                    <tr>
                        <th>{{$lang["report_orders_code"]}}</th>
                        <th>{{$lang["report_orders_date"]}}</th>
                        <th>{{$lang["report_orders_client"]}}</th>
                        <th>{{$lang["report_orders_credit"]}}</th>
                        <th>{{$lang["report_orders_shipping_fee"]}}</th>
                        <th>{{$lang["report_orders_charges"]}}</th>
                        <th>{{$lang["report_orders_received_total"]}}</th>
                    </tr>
                    </thead>
                    <tbody> 
                    @php
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="3">{{$lang["report_orders_total"]}}</th>
