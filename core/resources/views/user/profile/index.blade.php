      ...
      <div class="col-md-12">
        <div class="nav-wrapper">
          <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
              ...
              <li class="nav-item">
                  <button onclick="window.location.href='/user/account-compliance'" 
                          class="btn nav-link mb-sm-3 mb-md-0 
                   @if(url('/user/account-compliance') == url()->current()) active @endif" 
                          id="tabs-icons-text-6-tab" 
                          role="tab" 
                          aria-controls="tabs-icons-text-6" 
                          aria-selected="false">
                      <i class="fad fa-globe"></i> Verificar Documentos
                  </button>
              </li>
        ...
        <div class="tab-content" id="myTabContent">
                        ...
                        @csrf
                          <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                              <div class="row">
                                  <div class="col-6">
                                    <input type="text" name="first_name" class="form-control" placeholder="{{$lang["profile_index_first_name"]}}" value="{{$user->first_name}}" disabled>
                                  </div>      
                                  <div class="col-6">
                                    <input type="text" name="last_name" class="form-control" placeholder="{{$lang["profile_index_last_name"]}}" value="{{$user->last_name}}" disabled>
                                  </div>
                              </div>
                            </div>
                          </div>  
                          <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                              <input type="text" name="business_name" class="form-control" placeholder="Your Business Name" value="{{$user->business_name}}" required disabled>
                              <span class="form-text text-xs">{{$lang["profile_index_your_business_name_is_the_official_name"]}}</span>
                            </div>
                          </div>   
                        	<div class="form-group row">
                            <label class="col-form-label col-lg-3">CPF/CNPJ</label>
                            <div class="col-lg-9">
                              <div class="input-group">
                                <div class="input-group-prepend">
                                  <span class="input-group-text"><i class="fad fa-id-card"></i></span>
                                </div>
                                <input type="email" name="document" class="form-control" placeholder="CPF or CNPJ" value="{{$user->document}}" disabled>
                              </div>
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                              <div class="input-group">
                                ...
                                <input type="number" inputmode="numeric" name="phone" maxlength="14" class="form-control" value="{{$user->phone}}" disabled>
                              </div>
                            </div>
                          </div>     
                          <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                              <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="{{$lang["profile_index_email_address"]}}" value="{{$user->email}}" disabled>
                              </div>
                            </div>
                          </div>                          
            ...
            <div class="tab-pane fade @if(route('user.api')==url()->current())show active @endif" id="tabs-icons-text-3" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="callback-url" id="callback-url" class="form-control" placeholder="https://minhaurldecallback.com.br/callbacks" value="{{$user->callback_url}}">   
                          <div class="input-group-prepend">
              ...
              <div class="card">
                <div class="card-header header-elements-inline">
                  <h3 class="mb-0 font-weight-bolder">Documentação API</h3>
                </div>
                <div class="card-body">

                    <div class="form-group">
                        <label>Acesse nossa documentação, clicando no botão:</label><br>
                      <a href="https://github.com/AzzoPay/Documentacao-AzzoPay" target="_blank" class="btn btn-primary text-uppercase">Documentação GitHub</a>
                    </div> 
                  
                 	 <div class="form-group">
                        <label>Baixe a Trait para seu WebSite (Viper, ViperPro, DaanRox):</label><br>
                      <a href="https://github.com/AzzoPay/Trait-para-Website" target="_blank" class="btn btn-primary text-uppercase">Baixar Trait Laravel</a>
                    </div> 
