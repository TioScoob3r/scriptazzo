                      ...
                      <div class="row align-items-center">
                          <div class="col text-center">
                              ...
                              <span class="text-xl text-dark mb-0">
                                  {{$currency->symbol}} {{number_format($received, 2, ',', '.')}}
                              </span>
                              <br>
                              <hr>
                          </div>
                      ...
                      <div class="row align-items-center">
                          ...
                          <div class="col-auto">
                              <div class="my-4">
                                  ...
                                  <span class="surtitle ">{{$currency->symbol}} {{number_format($withdrawLimits->available_limit, 2, ',', '.')}}</span><br>
                                  <span class="surtitle ">{{$currency->symbol}} {{number_format($withdrawLimits->total_limit, 2, ',', '.')}}</span>
                              </div>
                          </div>
                      </div>
