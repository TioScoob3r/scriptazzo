            ...
            <div class="card-body pt-7 px-5">
              <div class="text-center text-dark mb-5">
                <div class="btn-wrapper text-center">
                  <a href="javascript:void;" class="">
                    <h1 class="btn-inner--icon font-weight-bolder">{{$currency->symbol}} {{$check->amount}}</h1>
                    <p class="text-sm text-primary mb-0">{{$lang["payment_charge"]}} {{$currency->symbol}} {{$check->charge}}</p>
                  </a>
                </div>
              </div>
              <div class="text-center">
                <form id="paymentForm">
                    ...
                    <button type="submit" class="btn btn-primary btn-block" onclick="payWithPaystack()">{{$lang["payment_pay_with_paystack"]}}</button>
                </form>
