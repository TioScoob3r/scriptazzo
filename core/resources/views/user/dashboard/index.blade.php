...
<div class="container-fluid mt--6">
    <div class="content-wrapper">
     ...
     <div class="row">
    <div class="col-12 col-md-12"> <!-- Use col-12 para mobile e col-md-6 para dispositivos maiores -->
        <div class="card">
            <div class="card-body text-center"> <!-- Alinhamento centralizado -->
                <h4 class="card-title">Informações da Conta</h4>
                <ul class="list-group">
                    <li class="list-group-item d-flex flex-column flex-md-row align-items-center">
                        <img src="{{ asset('asset/images/icons/card.svg') }}" alt="Ícone de Conta" width="55" height="30" class="mb-2 mb-md-0 mr-md-2"> <!-- Margem inferior para mobile -->
                        <span class="mr-md-2">Número da sua conta <b style="color:#8803ff;">Azzo</b><b style="color:#f07800;">Pay</b></span>
                        <input type="text" id="pixCode" class="form-control w-75" value="{{$user->account_id}}" readonly> <!-- Aumenta a largura no mobile -->
                        <div class="btn-group mt-2 mt-md-0" role="group"> <!-- Agrupa os botões -->
                            <button onclick="toggleVisibility()" class="btn btn-outline-secondary" title="Ocultar/Exibir Número">
                                <i id="toggleIcon" class="fa fa-eye-slash"></i>
                            </button>
                            <button onclick="copyPixCode()" class="btn btn-outline-secondary" title="Copiar">
                                <i class="fa fa-copy"></i>
                            </button>
                            <button onclick="sharePixCode()" class="btn btn-outline-secondary" title="Compartilhar">
