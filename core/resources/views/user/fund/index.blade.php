                    ...
                    <div class="col-lg-10 col-md-7">
                        <div class="accordion" id="accordionExample">
                            <div class="card bg-white border-0 mb-0">
                                ...
                                <div class="header" id="headingPayWithPix">
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="pix_client_name">Seu nome completo</label>
                                                            <input type="text" id="pix_client_name" name="pix_client_name" class="form-control" autocomplete="off" value="{{$user->first_name}} {{$user->last_name}}" disabled required/>
                                                        </div>
                                                    </div>
                                                    <div class="col col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            <label for="pix_client_document">CPF do titular</label>
                                                            <input type="text" id="pix_client_document" name="pix_client_document" class="form-control" autocomplete="off" value="{{$user->document}}" disabled required/>
                                                        </div>
                                                    </div>
                                                </div>
