    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav mb-3">
            <li class="nav-item">
              <a class="nav-link @if(route('user.dashboard')==url()->current()) active @endif" href="{{route('user.dashboard')}}">
                <img src="/asset/images/icons/home.svg" alt="Home Icon" class="icon-class" width="30" height="20" />
                <span class="nav-link-text" style="min-width:2rem;">{{$lang["user_layout_home"]}}</span>
              </a>
            </li>  
          </ul>
          <h6 class="navbar-heading p-0 text-muted">PAINEL CLIENTE</h6>
          <ul class="navbar-nav mb-3">   
            @if($set->transfer==1)                                          
              <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link @if(route('user.fund')==url()->current()) active @endif" href="{{route('user.fund')}}">
                ...
                <span class="nav-link-text">Depósito</span>
              </a>
            </li> 
            @if($set->vcard==1)
            ...
            <li class="nav-item">
              <a class="nav-link @if(route('user.ticket')==url()->current() || route('open.ticket')==url()->current()) active @endif" href="{{route('user.ticket')}}">
                ...
                <span class="nav-link-text">Suporte Ticket</span>
              </a>
            </li>         
          ...
          <h6 class="navbar-heading p-0 text-muted">DESENVOLVEDORES</h6>
          <ul class="navbar-nav mb-3">               
            ...
            */ ?>
            ...
            -->
                <li class="nav-item">
                    <a class="nav-link @if(route('user.api')==url()->current()) active @endif" target="DOCS" href="{{route('user.api')}}">
                  <i class="fad fa-laptop"></i>
                  <span class="nav-link-text">{{$lang["user_layout_website_integration"]}}</span>
                </a>
              </li>  
          ...
          <ul class="navbar-nav align-items-center ml-md-auto">
            ...
            <ul class="navbar-nav align-items-center ml-auto ml-md-0">    
              <li class="nav-item mr-2">
                <h6 class="h4 mb-0 text-gray font-weight-bolder"><span class="text-primary"><img src="/asset/images/icons/wallet.svg" alt="Wallet Icon" class="icon-class" />  {{ $currency->symbol }} {{number_format($user->balance, 2, ',', '.')}}</span></h6>
              </li>              
              <li class="nav-item dropdown">
                <a class="nav-link pr-0" aria-haspopup="true" aria-expanded="false">
                    <div class="media align-items-center">
                        <span class="avatar avatar-md rounded-circle" 
                              style="border: 3px solid {{ $user->kyc_status == 0 ? 'red' : 'green' }}; position: relative;">
                  ...
                  <span class="status-icon" style="
                      ...
                      border-color: red;                             
                      background-color: {{ $user->kyc_status == 0 ? 'red' : 'green' }};
                      color: white;
                      border-radius: 50%;
                      padding: 2px;
                      font-size: 10px;">
                  ...
                  <a href="{{route('user.security')}}" class="dropdown-item">
                    ...
                    @if ($user->compliance_gateway == "BANCO_ORIGINAL") 
                      <a href="{{ route('user.account-compliance') }}" class="dropdown-item">
                          ...
                          <span style="color: {{ $user->kyc_status == 0 ? 'red' : 'inherit' }};">                        
                              @if ($user->kyc_status == 0)
                            	  <b>{{$lang["user_layout_account_compliance"]}}</b>
                                  <i class="fas fa-times" style="color: red; margin-left: 5px;"></i>
                              @endif
                              @if ($user->kyc_status == 1)
                            	 {{$lang["user_layout_account_compliance"]}}
                              @endif
