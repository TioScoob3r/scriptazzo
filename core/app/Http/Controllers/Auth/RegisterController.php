...
class RegisterController extends Controller
{
    ...
    */
    ...
    {
        // Limpa o campo de telefone para conter apenas números
    	$request->merge([
        	'phone' => preg_replace('/\D/', '', $request->phone), // Remove todos os caracteres não numéricos
    	]);
    	...
    	if ($validator->fails()) {
        // Adicionando um campo extra 'error'...
        $data['title'] = 'Register';
        ...
        if($set->stripe_connect==1){
            ...
            try{
                ...
                $user = new User();
              	$user->account_id ='AZZO'.str_random(15);
                $user->image = 'person.png';
                $user->first_name = $request->first_name;
                $user->last_name = $request->last_name;
                $user->business_name = $request->business_name;
              	$user->document = $request->cpf_cnpj;
                ...
                $user->public_key='PUB-AZZO-'.str_random(32);        
           	 	$user->secret_key='SEC-AZZO-'.str_random(32);  
