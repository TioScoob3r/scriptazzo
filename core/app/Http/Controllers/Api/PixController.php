...
class PixController extends Controller {
    ...
    public function create(Request $request) {
        ...
        try {
            ...
            $pix = $IPix->criarCobrancaQrCode($clientData, $invoice->total, $gateway->val4, (!empty($invoice->notes) ? $invoice->notes : "Invoice {$invoice->ref_id}"), $sav);
            ...
            return response()->json(['error'=> $ex->getMessage(). " " . $ex->getFile() . " " .$ex->getLine()], (($ex->getCode() > 0 && is_numeric($ex->getCode())) ? $ex->getCode() : 400));
        }
